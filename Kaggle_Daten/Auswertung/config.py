...
DEFAULT_CONFIG: Dict[str, Any] = {
    ...
    # - "single_dataset": ein einzelner Datensatz (Crimes, Heart Failure, ...)
    ...
    # Generisches Entscheidungsattribut (bei Studenten = "Grade",
    # bei anderen Datensätzen etwas anderes, z.B. "Weapon Used Cd" oder "HeartDisease").
